                        ...
                        case ScreenState.LoadSaveData:
                            try:
                                ...
                                if (GradiusNeoGame.saveStorage.getNumRecords() == 0):
                                    initializeDefaultSaveData(GradiusNeoGame.saveData, {"screenSetup": GradiusNeoGame.state[22], "highestUnlockedStage": max(GradiusNeoGame.state[StateSlot.HighestUnlockedStage], DEVELOPMENT_HIGHEST_UNLOCKED_STAGE), "highestRound": GradiusNeoGame.state[33]})

export interface AudioPlayerListener {
  playerUpdate(player: AudioPlayer, event: string, eventData: unknown): void;
}
...
class MidiEngine {
  ...
  private static async create(): Promise<MidiEngine> {
    ...
    const module = (await import('../../j2me/media/libmidi/libmidi.js')) as LibMidiModule;
...
export class AudioPlayer {
  ...
  addPlayerListener(listener: AudioPlayerListener): void {
